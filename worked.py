...
# know = {}
# for path in os.listdir(cur_direc ):
#     img_know = face_recognition.load_image_file(cur_direc +'/'+path)
#     encoding = face_recognition.face_encodings(img_know)[0]
#     name = path.split('.')[0]
#     know[name] = encoding

# for f in list_of_files:
#     image_my = face_recognition.load_image_file(
#         list_of_files[f],mode='RGB')
#     image_encoding_my = face_recognition.face_encodings(
#         image_my,num_litters=1)
#     value += float(image_encoding_my)
# value_my = value/number_files
