...
class Face_Register:
    '''
    This function class is a wrapper for all parameteres of the GUI

    **Return**
    An interface to take photos of a person with face recognition
    ...
    def __init__(self):
        ...
        self.input_name_box = ""
        self.label_face_in_frame = tk.Label(
            self.frame_right, text="Faces in frame belongs to:")
    ...
    def create_face_folder(self):
        # This function aim to create folders for saving faces
    ...
    def GUI_input_name(self):
        # This function allows the user to input their name into the name box
    ...
    def save_current_photo(self):
        # This function intends to save the current face shown in the box to a folder
        if self.face_folder_created_flag:  # Makes the face in range
            if self.current_frame_faces_cnt == 1:  # Makes the face in the frame
                if not self.out_of_range_flag:  # Making sure there is a folder to save the face
                    self.ss += 1
    ...
    def GUI_info(self):
        # This function determines the font characters
    ...
    def check_existing_faces_cnt(self):
        # If there are already people registered in the folder
    ...
    def update_fps(self):
        ...
        # Shows the fps of the current video, the higher
        # the fps is the better we can recognize the face
        now = time.time()
